...
- **Tags:** [API]
- **Goal:** Spring REST Docs 또는 Swagger로 API 문서화, 포트폴리오 README 완성
...
Task 1은 30분이면 끝나고, Task 2의 감사 로그 기반이 갖춰져야 이후 모든 도메인 모듈이 감사를 자동 기록할 수 있다. 최대한 빠르게 Task 6(원장)과 Task 9(결제)에 도달하는 것이 목표 — 이 두 태스크가 프로젝트의 기술적 핵심이다.
